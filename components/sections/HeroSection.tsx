  ...
  return (
    <section className="relative h-dvh">
      <div className="relative flex flex-col gap-8 justify-center w-full h-full px-5 sm:px-20 z-1">
        <FadeContent duration={1} delay={1.5} className="flex items-center gap-4">
          <div className="flex flex-col">
            <p>
              <span className='underline'>Yohann RENAULD</span><br/>
        ...
        <FadeContent duration={1} delay={1.5}>
          <div className="flex flex-col items-center justify-end lg:flex-row gap-10">
            <p className="p-1 w-fit rounded-sm">
              Étant passionné de création visuel et d'animations,<br />
              je suis ouvert à tous type de projets.
            </p>
            <Cta size="xxl">
              <ArrowDown className="size-5 mt-1 animate-bounce" />Catégories
            </Cta>
          </div>
        </FadeContent>
      </div>
